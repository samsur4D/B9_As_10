    ...
    <div className="flex border mb-4  border-black flex-col w-full container mx-auto mt-20 rounded-2xl p-12 space-y-4 text-center dark:bg-gray-50 dark:text-gray-800">
      ...
      <form onSubmit={handelRegister} noValidate="" className="space-y-4">
        <div className="flex flex-col border border-y-gray-500">
          <label htmlFor="email" className="sr-only  border border-y-gray-700">
            Email address
          </label>
          <input
            id="email"
            ...
            className="rounded-t-md h-20 dark:border-gray-400 dark:bg-gray-50 dark:text-gray-800 focus:dark:ring-violet-600 focus:dark:border-violet-600 focus:ring-2"
          />
        </div>
        <div className="flex flex-col border border-y-gray-500 relative">
          ...
          <input
            ...
            className="-mt-1 rounded-b-md h-20  dark:border-gray-400 dark:bg-gray-50 dark:text-gray-800 focus:dark:ring-violet-600 focus:dark:border-violet-600 focus:ring-2"
          />
          <span
            className="absolute text-3xl mt-5 right-5 "
        ...
        <button
          type="submit"
          className="px-8 bg-black w-full text-white py-3 space-x-2 font-semibold rounded dark:bg-violet-600 dark:text-gray-50"
        >
          Register
        </button>
      </form>
